...
public class BallPractice extends JComponent implements ActionListener, KeyListener, MouseListener, MouseMotionListener {
	...
	public JTextField p1 = new JTextField("player");
	public JTextField pw = new JTextField("power");
	public JTextField tm = new JTextField("timer");
	public JTextField ph1 = new JTextField("playerhigh");
	...
	public void init() {
		...
		p1.setBounds(980, 190, 100, 25);
		pw.setBounds(930, 290, 200, 25);
		tm.setBounds(930, 390, 200, 25);
		ph1.setBounds(970, 140, 120, 25);
		...
		p1.setText("Player : " + String.valueOf(player1score));
		pw.setText(String.valueOf((powerx + powery) / 2));
		tm.setText("Time : 0"); 
		ph1.setText("Player Highest : " + String.valueOf(p1high));
	...
	public BallPractice() throws IOException {
		t.start();
