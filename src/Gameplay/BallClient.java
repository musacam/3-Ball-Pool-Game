...
public class BallClient extends JComponent implements ActionListener, KeyListener, MouseListener, MouseMotionListener {
    ...
    public BallClient() throws IOException {
        t.start();
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(player2 == false&&datataken == false) {
    		try {
				vx = in.readDouble();
				vy = in.readDouble();				
			    end = true;
    ...
    public void mouseClicked(MouseEvent e) {
    	if(player2 == true){
            if (e.getButton() == MouseEvent.BUTTON1 && cuevisibility == true || e.getButton() == MouseEvent.BUTTON1 && shootallthetime == true) {
                ...
                powerx = (mx - ball2.x) / 50;
                powery = (my - ball2.y) / 50;
                vx2 = powerx;
                vy2 = powery;
                end=true;
                pw.setText(String.valueOf((powerx+powery)/2));
